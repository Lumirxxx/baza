    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(
          "https://ipm-portal.ru/api/v1/wiki/list/",
          {
            headers: {
...
//         "http://5.182.4.206:8000/api/v1/token/refresh/",
//         {
...
//   };
  ...
  return (
    <div
      className="KnowledgeBase_page"
      style={{ backgroundImage: "url(/bgknow.svg)" }}
    >
      <MainHeader />
      ...
      <div className="KnowledgeBase_container">
        <div className="KnowledgeBase_content">
            <div className="KnowledgeBase_title-main">Продукты</div>
        {items.map((item, index) => (
          <div className="KnowledgeBase_item" onClick={() => handleButtonWikiClick(item.id)} key={index}>
           
              <div className="KnowledgeBase_item-logo" >
